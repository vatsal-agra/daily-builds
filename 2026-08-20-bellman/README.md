...
tabular Q-learning, SARSA, DQN, and REINFORCE — are implemented and
demonstrably working end to end, verified against exact value iteration
(GridWorld), the textbook Cliff Walking on/off-policy divergence, and
finite-difference gradient checks (the hand-rolled MLP). 88/88 tests
green. See [PLAN.md](PLAN.md) for the full design.
